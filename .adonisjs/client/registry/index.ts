...
const routes = {
  ...
  'admin.timeline.index': {
    ...
    tokens: [{"old":"/admin/timeline","type":0,"val":"admin","end":""},{"old":"/admin/timeline","type":0,"val":"timeline","end":""}],
    types: placeholder as Registry['admin.timeline.index']['types'],
  },
  'admin.timeline.store': {
    methods: ["POST"],
    pattern: '/admin/timeline',
    tokens: [{"old":"/admin/timeline","type":0,"val":"admin","end":""},{"old":"/admin/timeline","type":0,"val":"timeline","end":""}],
    types: placeholder as Registry['admin.timeline.store']['types'],
  },
  'admin.timeline.update': {
    methods: ["PUT"],
    pattern: '/admin/timeline/:id',
    tokens: [{"old":"/admin/timeline/:id","type":0,"val":"admin","end":""},{"old":"/admin/timeline/:id","type":0,"val":"timeline","end":""},{"old":"/admin/timeline/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['admin.timeline.update']['types'],
  },
  'admin.timeline.move': {
    methods: ["PUT"],
    pattern: '/admin/timeline/:id/move',
    tokens: [{"old":"/admin/timeline/:id/move","type":0,"val":"admin","end":""},{"old":"/admin/timeline/:id/move","type":0,"val":"timeline","end":""},{"old":"/admin/timeline/:id/move","type":1,"val":"id","end":""},{"old":"/admin/timeline/:id/move","type":0,"val":"move","end":""}],
    types: placeholder as Registry['admin.timeline.move']['types'],
  },
  'admin.timeline.destroy': {
    methods: ["DELETE"],
    pattern: '/admin/timeline/:id',
    tokens: [{"old":"/admin/timeline/:id","type":0,"val":"admin","end":""},{"old":"/admin/timeline/:id","type":0,"val":"timeline","end":""},{"old":"/admin/timeline/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['admin.timeline.destroy']['types'],
  },
  'admin.cv.index': {
    methods: ["GET","HEAD"],
    pattern: '/admin/cv',
    tokens: [{"old":"/admin/cv","type":0,"val":"admin","end":""},{"old":"/admin/cv","type":0,"val":"cv","end":""}],
    types: placeholder as Registry['admin.cv.index']['types'],
  },
  'admin.cv.update': {
    methods: ["PUT"],
    pattern: '/admin/cv',
    tokens: [{"old":"/admin/cv","type":0,"val":"admin","end":""},{"old":"/admin/cv","type":0,"val":"cv","end":""}],
    types: placeholder as Registry['admin.cv.update']['types'],
  },
  'admin.cv.pdf.store': {
    methods: ["POST"],
    pattern: '/admin/cv/pdf',
    tokens: [{"old":"/admin/cv/pdf","type":0,"val":"admin","end":""},{"old":"/admin/cv/pdf","type":0,"val":"cv","end":""},{"old":"/admin/cv/pdf","type":0,"val":"pdf","end":""}],
    types: placeholder as Registry['admin.cv.pdf.store']['types'],
  },
  'admin.legal.index': {
    methods: ["GET","HEAD"],
    pattern: '/admin/legal',
    tokens: [{"old":"/admin/legal","type":0,"val":"admin","end":""},{"old":"/admin/legal","type":0,"val":"legal","end":""}],
    types: placeholder as Registry['admin.legal.index']['types'],
  },
  'admin.legal.update': {
    methods: ["PUT"],
    pattern: '/admin/legal',
    tokens: [{"old":"/admin/legal","type":0,"val":"admin","end":""},{"old":"/admin/legal","type":0,"val":"legal","end":""}],
    types: placeholder as Registry['admin.legal.update']['types'],
  },
