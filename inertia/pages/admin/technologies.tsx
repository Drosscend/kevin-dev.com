...
function TechnologyForm({
  ...
  function submit(event: FormEvent) {
    ...
    const data = { ...values, docsUrl: values.docsUrl.trim() || null }
    const options = { preserveScroll: true, data, onSuccess: onDone }
    ...
    <form onSubmit={submit} className="grid gap-4 sm:grid-cols-2">
      ...
      <div className="space-y-2 sm:col-span-2">
        ...
        <Input
          ...
          onChange={(event) => setValues({ ...values, docsUrl: event.target.value })}
        />
        <FieldError errors={errors} field="docsUrl" />
      </div>
      <div className="space-y-2">
